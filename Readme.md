...
Лабораторная файловая система для Linux: модуль ядра регистрирует тип `rafs` в VFS. Данные не привязаны к блочному устройству — их отдаёт бэкенд, выбранный при сборке.
